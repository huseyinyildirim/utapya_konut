...
$sorgumesaj=("SELECT * FROM ank_mesajlar WHERE gonderen='$daire'");
$sorgumesaj=mysql_query($sorgumesaj) or die("Sorguda Hata : ".mysql_error());
$sayimesaj=mysql_num_rows($sorgumesaj);
$okundu=0;
$sorgumesaj3=("SELECT * FROM ank_ymesajlar WHERE daire='$daire' and okundu='$okundu'");
...
<div align="center">
  <center>
  <table border="1" cellpadding="1" cellspacing="1" style="border-collapse: collapse" width="800" height="76">
    <tr>
      <td colspan="3" align="center" height="25" bgcolor="#CEDDF0"><b><font face="Arial" size="2">
...
?>
  <div align="center">
    <center>
    <table border="1" cellpadding="1" cellspacing="1" style="border-collapse: collapse" width="800" height="75">
      <tr>
