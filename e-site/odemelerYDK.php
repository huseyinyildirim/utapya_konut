        ...
        <div align="center">
          ...
          <table border="1" cellspacing="1" style="border-collapse: collapse" width="750">
            <tr>
              ...
              <font face="Arial" style="font-size: 9pt">Saat</font></b></td>
              <td width="290" align="center"><b>
...
<select size="1" name="saat" id="odeme_saat">
              ...
              <option value="23">23</option>
              <option value="24">24</option>
              </select><select size="1" name="dakika" id="odeme_dakika">
              <option selected value="Dakika">Dakika</option>            
              <option value="00">00</option>
              <option value="15">15</option>
              <option value="30">30</option>
              <option value="45">45</option>
              </select></font></td>
              <td align="center" width="290"><font face="Arial" size="2">
              <input type="text" name="odeme_aciklama" id="odeme_aciklama" size="50"></font></td>              
        ...
        <div align="center">
          ...
          <table border="1" cellpadding="1" cellspacing="1"  style="border-collapse: collapse"  width="700">
            ...
            <tr>
              ...
              <td width="50" align="center"><b><font face="Arial" size="2">Saat</font></b></td>
...
?> 
            ...
            <tr>
              ...
              <td width="50" align="center"><font face="Arial" style="font-size: 9pt"><?echo $odemeci['saat'];?>:<?echo $odemeci['dakika'];?>
              </font>&nbsp;</td>
              <td align="left" width="475"><font face="Arial" style="font-size: 9pt"><?echo $odemeci['aciklama'];?></font>&nbsp;</td>
