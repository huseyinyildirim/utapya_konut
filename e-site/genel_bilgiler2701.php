  ...
  <table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="895">
    <tr>
      ...
      <table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="450" height="122">
        <tr>
          <td colspan="3" bgcolor="#C0C0C0" height="16"><b><font face="Arial" size="2">Site Yönetim Kurulu</font></b></td>
        </tr>
        <tr>
          <td width="200" height="24">
          <b><font face="Arial" size="2">İsim</font></b></td>
          <td width="150" height="24">
          <b><font face="Arial" size="2">Cep Telefonu</font></b></td>
          <td height="24">
          <b><font face="Arial" size="2">Daire</font></b></td>
        </tr>
        <tr>
          <td width="200" height="21">
          <input type="text" name="yon_ad1" id="yon_ad1" value="<?echo $genel['yon_ad1'];?>" size="20"></td>
        ...
        <tr>
          <td height="21">
          <input type="text" name="yon_ad2" id="yon_ad2" value="<?echo $genel['yon_ad2'];?>" size="20"></td>
          <td height="21">
        ...
        <tr>
          <td height="21">
          <input type="text" name="yon_ad3" id="yon_ad3" value="<?echo $genel['yon_ad3'];?>" size="20"></td>
          <td height="21">
      ...
      <table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="445" height="222">
        ...
        <tr>
          ...
          <input type="text" name="per_ad1" id="per_ad1" value="<?echo $genel['per_ad1'];?>" size="30"></td>
          <td height="21">
          <input type="text" name="per_gorev1" id="per_gorev1" value="<?echo $genel['per_gorev1'];?>" size="25"></td>
        </tr>
        <tr>
          <td height="21">
          <input type="text" name="per_ad2" id="per_ad2" value="<?echo $genel['per_ad2'];?>" size="30"></td>
          <td height="21">
          <input type="text" name="per_gorev2" id="per_gorev2" value="<?echo $genel['per_gorev2'];?>" size="25"></td>
        </tr>
        <tr>
          <td height="21">
          <input type="text" name="per_ad3" id="per_ad3" value="<?echo $genel['per_ad3'];?>" size="30"></td>
          <td height="21">
          <input type="text" name="per_gorev3" id="per_gorev3" value="<?echo $genel['per_gorev3'];?>" size="25"></td>
        </tr>
        <tr>
          <td height="21">
          <input type="text" name="per_ad4" id="per_ad4" value="<?echo $genel['per_ad4'];?>" size="30"></td>
          <td height="21">
          <input type="text" name="per_gorev4" id="per_gorev4" value="<?echo $genel['per_gorev4'];?>" size="25"></td>
        </tr>
        <tr>
          <td height="21">
          <input type="text" name="per_ad5" id="per_ad5" value="<?echo $genel['per_ad5'];?>" size="30"></td>
          <td height="21">
        ...
        <tr>
          <td height="21">
          <input type="text" name="per_ad7" id="per_ad7" value="<?echo $genel['per_ad7'];?>" size="30"></td>
          <td height="21">
    ...
    <tr>
      ...
      <div align="center">
        ...
        <table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="890" height="135">
          <tr>
            <td colspan="4" height="16" bgcolor="#C0C0C0"><b><font face="Arial" size="2">Site Banka Bilgileri</font></b></td>
          </tr>
          <tr>
