...
include("baglan.php");
$bilgisor=mysql_query("select * from delegeler where adi like '%".$_POST["adi"]."%' and misafir='$misafir'"); 
...
<div align="center">
  ...
  <table border="1" cellpadding="1" cellspacing="1" style="border-collapse: collapse" width="800" id="AutoNumber1" height="49">
    ...
    <tr>
      ...
      <td width="210" height="16"><u><b><font face="Arial" size="2">Kurum</font></b></u></td>
      <td width="150" height="16"><u><b><font face="Arial" size="2">Unvan</font></b></u></td>
      <td width="100" height="16"><u><b><font face="Arial" size="2">Otel</font></b></u></td>
      <td width="110" height="16"><u><b><font face="Arial" size="2">Giriş Tarihi</font></b></u></td>      
