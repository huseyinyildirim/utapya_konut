...
function SayiKontrol(e) {
	...
	{		
		...
		function genel_guncelle()
		{
	var cevap=confirm("Site Bilgilerini Güncelleme İşlemini Onaylıyor Musunuz?");
	...
	{		
			...
			(
				{
					type:'POST',
					url:'genel_guncelle.php',
					data:'yon_ad1=' + document.getElementById('yon_ad1').value +
					     '&yon_ad2=' + document.getElementById('yon_ad2').value+	
					     '&yon_ad3=' + document.getElementById('yon_ad3').value+	
					     '&den_ad1=' + document.getElementById('den_ad1').value+		
					     '&den_ad2=' + document.getElementById('den_ad2').value+	
					     '&den_ad3=' + document.getElementById('den_ad3').value+						 						 					 
					     '&yon_cep1=' + document.getElementById('yon_cep1').value+	
					     '&yon_cep2=' + document.getElementById('yon_cep2').value+	
					     '&yon_cep3=' + document.getElementById('yon_cep3').value+
					     '&den_cep1=' + document.getElementById('den_cep1').value+	
					     '&den_cep2=' + document.getElementById('den_cep2').value+	
					     '&den_cep3=' + document.getElementById('den_cep3').value+						 						 					 			
					     '&yon_daire1=' + document.getElementById('yon_daire1').value+		
					     '&yon_daire2=' + document.getElementById('yon_daire2').value+		
					     '&yon_daire3=' + document.getElementById('yon_daire3').value+
					     '&den_daire1=' + document.getElementById('den_daire1').value+
					     '&den_daire2=' + document.getElementById('den_daire2').value+
					     '&den_daire3=' + document.getElementById('den_daire3').value+						 						 						 		
					     '&per_ad1=' + document.getElementById('per_ad1').value+
					     '&per_ad2=' + document.getElementById('per_ad2').value+	
					     '&per_ad3=' + document.getElementById('per_ad3').value+	
					     '&per_ad4=' + document.getElementById('per_ad4').value+	
					     '&per_ad5=' + document.getElementById('per_ad5').value+	
					     '&per_ad6=' + document.getElementById('per_ad6').value+	
					     '&per_ad7=' + document.getElementById('per_ad7').value+						     					     					     					     					     					     	
					     '&per_gorev1=' + document.getElementById('per_gorev1').value+
					     '&per_gorev2=' + document.getElementById('per_gorev2').value+
					     '&per_gorev3=' + document.getElementById('per_gorev3').value+
					     '&per_gorev4=' + document.getElementById('per_gorev4').value+
					     '&per_gorev5=' + document.getElementById('per_gorev5').value+
					     '&per_gorev6=' + document.getElementById('per_gorev6').value+
					     '&per_gorev7=' + document.getElementById('per_gorev7').value+					     					     					     					     					     					     		
					     '&banka_ad1=' + document.getElementById('banka_ad1').value+		
					     '&banka_ad2=' + document.getElementById('banka_ad2').value+
					     '&banka_ad3=' + document.getElementById('banka_ad3').value+
					     '&banka_sube1=' + document.getElementById('banka_sube1').value+
					     '&banka_sube2=' + document.getElementById('banka_sube2').value+					     	
					     '&banka_sube3=' + document.getElementById('banka_sube3').value+
					     '&banka_hesap1=' + document.getElementById('banka_hesap1').value+	
					     '&banka_hesap2=' + document.getElementById('banka_hesap2').value+	
					     '&banka_hesap3=' + document.getElementById('banka_hesap3').value+	
					     '&hesap_ad1=' + document.getElementById('hesap_ad1').value+	
					     '&hesap_ad2=' + document.getElementById('hesap_ad2').value+	
					     '&hesap_ad3=' + document.getElementById('hesap_ad3').value+						 	
					     '&iban1=' + document.getElementById('iban1').value+	
					     '&iban2=' + document.getElementById('iban2').value+			 						 					     				     						     					     								     					     
					     '&iban3=' + document.getElementById('iban3').value,
					success:function(ajax_cevap)
					{
			$('#Orta_Yukleniyor').hide();
			$('#Orta_Sonuc').show();					
	...
	{		
     ...
     return false;
		...
		function toplu_mesaj_gonder()
		{

		a= document.getElementById('toplu_mesaj').value
       if (a == ""){
        alert('Lütfen Mesajınızı Yazınız');
        document.getElementById('toplu_mesaj').focus();
     return false;
     }  
			...
			(
				{
					type:'POST',
					url:'toplu_mesaj_gonder.php',
					data:'toplu_mesaj=' + document.getElementById('toplu_mesaj').value,
					success:function(ajax_cevap)
					{
						$('#Orta_Yukleniyor').hide();
						$('#Orta_Sonuc').show();
...
siteodeme();
     ...
     return false;
		...
		function tumdaireborcodeme_getir()
		{
			...
			(
				{
					type:'POST',
					url:'tumdaireborcodeme_getir.php',
					success:function(ajax_cevap)
					{
						$('#sorgu_Yukleniyor').hide();
						$('#sorgu_Sonuc').show();
