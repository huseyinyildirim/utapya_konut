...
<div align="center">
  ...
  <table border="1" cellpadding="0" cellspacing="1" style="border-collapse: collapse" width="940" height="97">
    <tr>
      ...
      <p align="right"><b><font face="Arial" style="font-size: 13pt">Toplam Borcunuz <?echo round($borc_toplam);?> TL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </font></b>
      </td>
    </tr>
    <tr>
          ...
          <div align="center">
            ...
            <table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="420">
              <tr>
                ...
                <td align="center" width="100" bgcolor="#CCCCCC"><b>
...
?>              
              ...
              <tr>
                <td><font face="Arial" size="2"><?echo $borc['borc_turu'];?></font></td>
                <td><font face="Arial" size="2"><?echo $borc['aciklama'];?></font></td>                
                <td align="center"><font face="Arial" size="2">
                <?echo $borc['borc_donemay'];?>-<?echo $borc['borc_donemyil'];?></font></td>
                <td align="right" width="70"><font face="Arial" size="2"><?echo $borc['borc_tutar'];?> TL</font></td>
              </tr>
<?
}
?>                
