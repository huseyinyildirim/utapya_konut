...
$okundu=0;
$gonderen="Yönetim";
$sorgumesaj3=("SELECT * FROM mesajlar WHERE daire_no='$daire' and okundu='$okundu' and gonderen='$gonderen'");
...
{
$cevap_metni=$mesajlari['cevap_metni'];
if($cevap_metni==""){ 
$cevap_metni="BU MESAJ HENÜZ CEVAPLANMAMIŞ";
}
?>      
      <tr>
        <td height="17"><font face="Arial" style="font-size: 9pt"><?echo $mesajlari['mesaj'];?></font></td>
        <td height="17"><font face="Arial" style="font-size: 9pt"><?echo $mesajlari['tarih'];?></font></td>
        <td height="17"><font face="Arial" style="font-size: 9pt"><?echo $cevap_metni;?></font></td>
        <td height="17"><font face="Arial" style="font-size: 9pt"><?echo $mesajlari['cevap_tarih'];?></font></td>
      </tr>
<?
}
?>      
