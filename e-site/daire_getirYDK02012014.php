...
?>					
          ...
          <tr>
            ...
            <div align="center">
              ...
              <option value="Isınma Gideri">Isınma Gideri</option>
              </select>
          ...
          <tr>
            ...
            <div align="center">
              ...
              <table border="0" cellpadding="0" cellspacing="1" style="border-collapse: collapse" width="400">
                <tr>
                  <td width="120" align="left" bgcolor="#CCCCCC"><b><font face="Arial" size="2">
                  Borç Türü</font></b></td>
                  <td width="140" align="center" bgcolor="#CCCCCC"><b><font face="Arial" size="2">
                  Dönemi</font></b></td>
                  <td width="80" align="center" bgcolor="#CCCCCC"><b><font face="Arial" size="2">
                  Tutar</font></b></td>
                  <td width="60" align="center" bgcolor="#CCCCCC"><b><font face="Arial" size="2">
                  İşlem</font></b></td>
                </tr>
<?                
...
?>                
                <tr>
                  <td bgcolor="<?echo $renk;?>" width="120" align="left"><font face="Arial" size="2"><?echo $borc['borc_turu'];?>
</font>&nbsp;</td>
                  <td bgcolor="<?=$renk?>" width="140" align="center"><font face="Arial" size="2">
                  ...
                  <td bgcolor="<?=$renk?>" width="67" align="center"><font face="Arial" size="2"><input type="submit" value="Sil" name="borcsil" onClick="return borc_sil(<?echo $borc['id'];?>)"></font></td>
                </tr>
<?
}
?>                
