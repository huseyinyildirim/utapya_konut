...
<div align="center">
    <center>
    <table border="1" cellspacing="1" style="border-collapse: collapse" width="940" id="AutoNumber1" height="175">
      <tr>
      ...
      <tr>
        <td width="790" height="136">
        <div align="center">
          <center>
          <table border="1" cellspacing="1" style="border-collapse: collapse" width="587" height="100">
            <tr>
...
?>              
        ...
        <div align="center">
          ...
          <table border="1" cellspacing="1" style="border-collapse: collapse" width="587" height="100">
            <tr>
              <td width="573" align="center" height="34" colspan="3"><b>
              <font face="Arial" size="2" color="#FF0000">Tüm Dairelere Mesaj Gönder</font></b></td>
            </tr>
            <tr>
              <td align="center" height="34" width="153">&nbsp;</td>
              <td align="center" height="34" width="278"><font face="Arial" size="2">
              <textarea rows="3" name="S1" id="toplu_mesaj" cols="30"></textarea></font></td>
              <td align="center" height="34" width="142"><font face="Arial" size="2">
              <input type="button" value="Mesajı Gönder" name="B1" onClick="return toplu_mesaj_gonder()" ></font></td>
            </tr>
          </table>
          </center>
        </div>        
